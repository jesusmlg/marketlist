Marketlist::Application.routes.draw do
  ...
  match '/remove_restore_from_list/(:list_id)', to: 'products#remove_restore_from_list', via: 'post'
  match '/list_to_buy(/:order)(/:list_id)', to: 'products#index', as: 'list_to_buy', via: 'get'
